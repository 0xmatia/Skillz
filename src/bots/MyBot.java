    ...
    public class MyBot implements PirateBot
    {
        public void doTurn(PirateGame game)
        {
            ...
            if (game.getMyMothership().location.col == 500)
            {
                ...
                start1 = new Location(3540, 5909);
                push = new Location(3930, 6357);
            } else
            {
                start = new Location(3029, 832);
                start1 = new Location(2803, 361);
                push = new Location(2485, 0);
            }
            ...
            if (flag1)
            {
                ...
                defPirates[6].sail(start1);
                defPirates[7].sail(start1);
            }
    /////////////////////////////////// --ATTACK---///////////////////////////////////////////////////////////////////
            for (int i = 0; i <= 3; i++)
            {
